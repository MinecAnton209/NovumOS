...
fn execShell(_: []const u8, _: parser.Statement) void {
    common.printZ("shell_exec: Not supported in Ring 3\n");
}
...
pub fn execute(buffer: []const u8, stmt: parser.Statement, exit_flag: *bool) void {
    switch (stmt.cmd_type) {
        ...
        .reboot => common.printZ("reboot: Not supported in Ring 3\n"),
        .shutdown => common.printZ("shutdown: Not supported in Ring 3\n"),
        .exit => exit_flag.* = true,
